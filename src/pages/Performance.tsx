    ...
    <AppLayout>
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="section-header !mb-0 flex-1" style={{ '--section-color': 'var(--section-finance)' } as React.CSSProperties}>
            <div className="section-icon">
              <AlertCircle className="h-5 w-5" />
            </div>
            <div>
              <h1 className="section-title">Performance Insight</h1>
              <p className="section-subtitle">Dashboard efektivitas biaya & kinerja tim</p>
            </div>
          </div>
