              ...
              {connecting ? (
                <div className="flex flex-col items-center justify-center py-12 gap-4">
                  ...
                  <div className="text-center">
                    <p className="font-medium">Connecting to {platform === "instagram" ? "Instagram" : "Facebook"}...</p>
        ...
        {isLoading ? (
          ...
          <Card className="col-span-full">
            <CardContent className="pt-6 text-center py-12">
              <p className="text-muted-foreground">No accounts connected yet. Click "Connect Account" to get started.</p>
            </CardContent>
          </Card>
        ) : (
